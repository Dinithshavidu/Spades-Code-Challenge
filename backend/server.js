...
mongoose.connect("mongodb+srv://dinith:dinith@cluster0.gtkun.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", { useNewUrlParser: true });
...
todoRoutes.route("/auth/:email/:pasword").get(function(req, res) {
  if(req.params.email == "dinith@gmail.com" && req.params.password == "1234"){
